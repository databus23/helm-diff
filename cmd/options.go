...
func AddDiffOptions(f *pflag.FlagSet, o *diff.Options) {
	...
	f.StringVar(&o.OutputFormat, "output", "diff", "Possible values: diff, simple, template, json, dyff, ai. When set to \"template\", use the env var HELM_DIFF_TPL to specify the template.")
